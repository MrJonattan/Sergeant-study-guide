...
## A.G. 331-01: Evaluations — General — Members of the Service

**Effective:** 08/20/25 | **Last Revision:** R.O. 75 | **Pages:** 1-6

### Purpose

To ensure that each uniformed and civilian member of the service is evaluated at least once each year.

### Scope

All uniformed and civilian members of the service, regardless of rank or assignment, will be evaluated in accordance with this procedure and the chart provided in Appendix "A."
...
6. Discuss the Department's equal employment opportunity (EEO) policy with ratee.
   ...
   - d. Record comments in the sections devoted to the "Overall Rater's Comments" indicating how well a supervisor has demonstrated their compliance with the Department's EEO policy.
...
11. Review all **PERFORMANCE EVALUATIONS** of subordinate personnel.
...
- Members absent for military service are still entitled to a **PERFORMANCE EVALUATION**. Per NY State Military Law, raters take the average of the three prior evaluations. The credited rating must not be less than satisfactory (3.0) or less than the rating for the period immediately prior to military absence.
- **Probationary members** do not receive annual evaluations. An annual evaluation will be prepared during the next rating period after attaining permanent rank.
- Members on probation (entry-level probationary police officers, probationary sergeants, etc.) and civilians who have not completed probation or served less than two years in provisional status **are not permitted to appeal** their evaluation.
- **Probation period:** All newly promoted sergeants, lieutenants, and captains are on probation for **12 months**. Extension up to an additional **6 months** may be authorized case-by-case.
- Extension of probation may be requested **after 6 months** by the probationary member's CO, accompanied by the **4th month PERFORMANCE EVALUATION**. Forwarded to Deputy Commissioner, Risk Management.
- Raters must give recognition to members who utilize **language proficiency** for translation/interpretation duties. Experience gained as translator/interpreter in criminal investigations will be included in the Overall Rater's Comments.
...
- Rater must review: CPI record, recognition, sick record, commendation letters, CCRB record, Command Discipline Log, Supervisor Feedback Form
- Must comment on all dimensions rated **below competent** (rated 2 or 1)
- Must discuss **EEO policy** with ratee and document in Overall Rater's Comments
- Review and update **FORCE RECORD (PD406-143)** during evaluation
- Report **Chronic Absent** attendance improvement efforts
- Reviewer rates "Very Low" for **Chronic Absent - Category B**
- Below competent (2.5 or lower) or extremely competent (5.0): reviewer must be **captain or above**
- Performance Monitoring Program ratees: reviewer must be the **commanding officer**
- Probation for newly promoted sergeants: **12 months**, extendable up to **6 additional months**
- Extension request made after **6 months**, accompanied by **4th month evaluation**
- Transfer evaluations must be prepared; forward to **new command**
- Members rated by command assigned to on **last day of rating period**
- Probationary members **cannot appeal** their evaluation
- **Military absence:** average of 3 prior evaluations, minimum satisfactory (3.0)

---

## A.G. 331-02: Evaluation of Probationary Officers
...
> **NOTE:** *When recommending "Termination of Services" or "Extension of Probation" a detailed report to Commanding Officer, Performance Analysis Unit, including all pertinent facts related to the probationary police officer's performance, will be forwarded with a copy of the PERFORMANCE EVALUATION. If warranted, these recommendations may also be forwarded at any time during the probationary period, prior to the twenty-second month anniversary.*

### Additional Data

The probationary period should be utilized to closely scrutinize the member's performance to assess their abilities as a police officer. The entry level probationary period may be extended an additional six months, if necessary. When a probationary officer is transferred to a command, their performance from the previous command must be reviewed. Interim evaluations should be prepared when it is apparent there is a problem with an officer's performance. Supervisors should document below-standards performance using the **SUPERVISOR FEEDBACK FORM**, command discipline, and charges and specifications when appropriate.

### Sergeant Exam Focus
- Form: **RECRUIT EVALUATION (PD439-1412)** — 2 copies prepared by Police Academy
- Probationary PO evaluated **3 times**: 10th, 16th, and 22nd month
- 22nd month evaluation must recommend: **Permanent Appointment**, **Extension of Probation**, or **Termination of Services**
- Notify **Performance Analysis Unit** if overall evaluation less than **3.0**
- Forward signed copy to **Personnel Services Unit**
- Reports during probation on **Typed Letterhead**: Charges/Specs to First Deputy Commissioner; fitness matters to Chief of Personnel in sealed envelope
...
### Sergeant Exam Focus
- Investigative (Detective Track) officers evaluated **twice** in first 15 months: **8th and 15th month**
- After 15 months: evaluated **annually**
- Change in performance after 15th month: **immediate interim evaluation** required
- Chronic Absent - Category B investigators: presumed **substandard** performance
- Category B rated higher than "Low" — rater must **justify** how performance was achieved despite absences
- Rater must state whether ratee should **remain in investigative assignment**
- Detectives: determine if designation should be **retained or revoked**
- Rater must **audit investigative time** accrued by members

---

## A.G. 331-04: Evaluations of Police Officers and Detectives Assigned to Non-Investigative Duties
...
16. Provide comments.
17. Accept or appeal **PERFORMANCE EVALUATION**.

**RATER:**

18. Comply with A.G. 333-10, "Appeal of Evaluation — Uniformed Members of the Service," when member of the service appeals their PERFORMANCE EVALUATION.
    - a. Notify commanding officer of ratee's decision to appeal.
...
21. Provide a copy of **PERFORMANCE EVALUATION** to ratee.
...
- Appraisal of subordinates' performance is a **continuous process**. The Performance Evaluation System does NOT relieve supervisors of their responsibility to monitor and document subordinates' performance throughout the rating period.
- EEO factors (substantiated EEO violations) must be considered.
- Language proficiency recognition applies.
- Military absence: average of three prior evaluations, minimum "meets standards" (68-76) or not less than immediately prior rating.
- If a **PERFORMANCE EVALUATION** has been prepared in error, a report on **Typed Letterhead** will be submitted to the Performance Analysis Unit requesting that the evaluation be voided/deleted from the system.

### Sergeant Exam Focus
- Non-investigative Bureaus use the **PERF System** (Performance Evaluation System)
- **Supervisor's Quarterly Evaluations** must be completed before annual evaluation
- Rater reviews: Officer Profile Reports, Supervisor Feedback Forms, Officer Self-Report Forms, Quarterly Evaluations, Command Discipline Log, CPI, recognition, sick, commendation, CCRB
- **Annual score to rating conversion** — know the scale:
  - 90-100 = Exceptional
  - 77-89 = Exceeds Expectations
  - 68-76 = Meets Standards
  - 60-67 = Needs Improvement
  - 59 or below = Unsatisfactory
- Needs improvement/unsatisfactory (67 or lower) or exceptional (90+): reviewer must be **captain or above**
- Annual evaluations finalized by **January 31st**
- Interview ratee in a **private setting**
- Ratee may **accept or appeal**
- Evaluation prepared in error: submit **Typed Letterhead** to Performance Analysis Unit to void/delete
...
- Rater performing evaluation of a precinct detective squad supervisor or commander will confer with the precinct commanding officer to ascertain the CO's overall evaluation of the precinct detective squad supervisor/commander's performance. Conferral with the precinct commanding officer and the precinct commanding officer's overall evaluation will be noted in the RATER COMMENTS section.
- Military absence: average of three prior evaluations, minimum satisfactory (3.0) or not less than the rating for the period immediately prior to military absence.

### Sergeant Exam Focus
- **Probationary sergeants** evaluated at **4th and 10th month** (16th month only if probation extended)
- Probationary lieutenants: same schedule — **4th and 10th month**
- After probation: evaluated **annually**
- **Detective squad supervisors/commanders**: rater must confer with **precinct commanding officer** and note CO's evaluation in Rater Comments
- Signed copy for probationary sergeants/lieutenants forwarded to **Probationary Monitoring Unit, One Police Plaza, Room 1000**
- Interim evaluations submitted when performance changes

---

## A.G. 331-06: Evaluation of Captain Through Deputy Chief
...
- Military absence: average of three prior performance evaluations, minimum satisfactory (3.0) or not less than the rating for the period immediately prior to military absence.

### Sergeant Exam Focus
- Probationary captains evaluated **3 times**: 4th, 10th, and 16th month
- Captains on probation for **12 months** (extendable 6 months)
- Permanent captains through deputy chiefs use **Management By Objectives (MBO)** system
- **5 Key Result Areas (KRAs)** defined at beginning of rating period
- Evaluation forwarded to Human Resources Division at start of rating period (**July 1st**)
- Precinct commander captains: rated by **patrol borough operations commander**; reviewed by **patrol borough commander**
- Deputy Inspectors+ as precinct commanders: rated by **patrol borough adjutant**; reviewed by **patrol borough commanding officer**
