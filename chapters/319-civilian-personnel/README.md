...
| File | Content |
|------|---------|
| `section-319-07.md` | A.G. 319-07: Sick leave reporting, absence control steps (O-IV), documentation requirements, six-month periods |
| `section-319-civilian-injury.md` | A.G. 319-08: Injury reporting, 5 required forms, notification timelines, Workers Compensation |
| `section-319-11.md` | A.G. 319-11: Civilian employee disciplinary procedures, warning requirements |
| `key-terms.md` | Forms list, key timeframes, absence control steps, Chief of Personnel authority |
| `review-questions.md` | Multiple-choice questions covering civilian injury reporting and sick leave procedures |
